...
- [~] red-usecase (coverage: `_NullUnitOfWork.rollback()` line reached when no real unit_of_work injected and a failure occurs)
- [ ] green-usecase (coverage: `_NullUnitOfWork.rollback()` line reached when no real unit_of_work injected and a failure occurs)
