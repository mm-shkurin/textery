...
- [~] red-usecase (coverage: account_repository.save() non-ConflictException failure triggers rollback + sanitized RegistrationFailedException, not a raw unrolled-back propagation) — closes agent-review's finding on the green-usecase commit
