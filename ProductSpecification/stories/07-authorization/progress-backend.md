...
- [ ] red-usecase (coverage: verify commits silently with no injected unit of work)
- [ ] green-usecase (coverage: verify commits silently with no injected unit of work)
- [ ] adapters-discovery
- [ ] green-acceptance
