...
- [ ] **P0-1** — Backend 1.1: Reject request with missing topic (`red-acceptance` + `design` + `red-usecase` + `green-usecase` + `adapters-discovery` done, see `decisions/request-validation-architecture-decision.md`; `red-adapter rest` next)
