...
describe('ManualEditor link popover — captured range contract', () => {
  ...
  it.skip('opening with the caret inside an existing link prefills the field with that href and Применить replaces it in place', async () => {
  ...
  it.skip('Применить acts on the range captured when the popover opened, not the caret moved elsewhere while it was open', async () => {
  ...
  it.skip('a rejected apply keeps the captured range, so the corrected retry still lands on the originally selected text', async () => {
    const contentArea = await openLinkPopover()
