...
get_resend_code_usecase = auth_router_module.get_resend_code_usecase


class TestGetResendCodeUsecaseDependencyStub:
    """Coverage: get_resend_code_usecase DI stub raises NotImplementedError.
